...
import { type QuestionProps } from '@/http/types/question'

export function QuestionItem({ question }: { question: QuestionProps }) {
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end">
            <span className="text-muted-foreground text-xs">
              ...
              às{' '}
              {new Date(question.createdAt).toLocaleTimeString('pt-BR', {
                hour: '2-digit',
                minute: '2-digit',
              })}
            </span>
